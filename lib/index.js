...
const lType = [[4, 0, 0], [4, 0, 0], [4, 0, 0]];

const jType = [[0, 0, 5], [0, 0, 5], [0, 0, 5]];

const oType = [[6, 6], [6, 6]];

const tType = [[0, 7, 0], [7, 7, 7], [0, 0, 0]];

const blockColors = ['limegreen', 'darkorange', 'mediumorchid', 'dodgerblue', 'orangered', 'cornflowerblue', 'tomato'];
...
>>>>>>> b7741c10566dc64aadaa1374a50b785cc16942fb
...
const genereateField = (rows, cols) => {
    const field = Array.from({ length: rows }, () => Array.from({ length: cols }, () => 0));
    return field;
};
